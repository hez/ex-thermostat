defmodule ExThermostat.DummyTempSensor do
  @moduledoc false
  use GenServer
  ...
  def handle_info(:poll, state) do
    ...
    new_t =
      case ExThermostat.status().heater_on do
    ...
    ExThermostat.PubSub.broadcast(:temperature, %{temperature: new_t, humidity: new_h})
